...
va_list list, char buffet[], int flags, int width, int precision, int size);
...
int flags, int width, int precision, int size);
int write_num(int ind, char bff[], char buffer[],
int flags, int width, int precision, int size
char padd, char extra_c);
int write_pointer(int ind, char buffer[], char padd,
